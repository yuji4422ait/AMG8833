...
i2c.write_byte_data(addr,0x02,0x01)
...
try: 	                                             # 例外が発生する可能性がある処理
	...
	while index <= 10:                              # index 「1」「2」「3」...と1から順に番号が割り当て,繰り返し回数
		...
		#print('Thermistor Temp:',Atemp)
		#print("///////////")
		#Atemp1 = i2c.read_word_data(addr, REG_TOOL)
		#Atemp1 = Atemp1 * 0.0625
		#print(Atemp1)
		#print("^^^^^^^^^^^")
		#ObjectTemp1 = i2c.read_word_data(addr, REG_PIXL)
		#ObjectTemp1 = ObjectTemp1 * 0.25
		#print(ObjectTemp1)
		#print("@@@@@@@@@@@")
		
		ObjectTemp_all = myeye.pixelOut()
		ObjectTemp_all =np.array(ObjectTemp_all).reshape(8,8)
		#print (ObjectTemp_all)
		#print (type(ObjectTemp_all))
		#print (ObjectTemp_all.dtype)
		#print("::::::::::::")
